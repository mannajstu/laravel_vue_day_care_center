                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>ID</th>
                                            <td>{{ parenttoadminmsg.id }}</td>
                                            
                                        </tr>
                                        <tr>
                                            <th>Subject</th>
                                            <td>{{ parenttoadminmsg.subject }}</td>
                                        </tr>
                                        <tr>
                                            <th>Message</th>
                                            <td>{{ parenttoadminmsg.message }}</td>
                                        </tr>
...
<script>
  ...
  methods: {
    singleparenttoadminmsg () {
      // Submit the form via a POST request
      let id=this.$route.params.id;
      axios.get('/singleparenttoadminmsg/'+id)
        .then(({ data }) => 
        { 
           this.parenttoadminmsg=data;
           console.log(data);
        }
        )
    },
