                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>ID</th>
                                            <td>{{ doctortoparentmsg.id }}</td>
                                            
                                        </tr>
                                        <tr>
                                            <th>Subject</th>
                                            <td>{{ doctortoparentmsg.subject }}</td>
                                        </tr>
                                        <tr>
                                            <th>Message</th>
                                            <td>{{ doctortoparentmsg.message }}</td>
                                        </tr>
...
<script>
  ...
  methods: {
    singledoctortoparentmsg () {
      // Submit the form via a POST request
      let id=this.$route.params.id;
      axios.get('/singledoctortoparentmsg/'+id)
        .then(({ data }) => 
        { 
           this.doctortoparentmsg=data;
           console.log(data);
        }
        )
    },
